...
import com.example.DuQuanLin2019211003000234.dao.OrderDao;
import com.example.DuQuanLin2019211003000234.model.Item;
import com.example.DuQuanLin2019211003000234.model.Order;
import com.example.DuQuanLin2019211003000234.model.Payment;
...
public class OrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String message = null;
        if(customerId==0 || paymentId==0 || firstName.trim().length()==0 || phone==null || phone.trim().length()==0||
