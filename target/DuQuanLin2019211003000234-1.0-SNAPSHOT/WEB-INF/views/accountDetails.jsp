		...
		<div class="container">
			...
			<h1>No Order Found.</h1>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td class="cart_total">
						<%
							com.example.DuQuanLin2019211003000234.model.Order o=(com.example.DuQuanLin2019211003000234.model.Order)pageContext.findAttribute("o");
							int n=o.getPaymentId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							String paymentType=com.example.DuQuanLin2019211003000234.model.Payment.findByPaymentId(con,n);
							 %>
